...
Перед нами стоит задача спарсить данные о холодильниках с Яндекс маркета.
...
Наконец, создаем датафрейм на основе полученных данных и записываем его в csv файл.
