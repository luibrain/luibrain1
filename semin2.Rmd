...
Перед нами стоит задача построить 3 способами коробчатые диаграммы за январь-август по годам четырех групп стран-поставщиков: США, страны латинской америки, страны ЕС и все остальные.
...
Берем только данные за январь-август.
...
Стоит отметить, что страны латинской америки отсутствуют.
...
Этот пакет обладает малым набором возможностей, так, например, не удалось изобразить коробчатые диаграммы на 1 графике, т.к. присоединение "|" не предусмотрено. Пришлось строить 3 различных диаграммы с параметрами c(2,2).
...
Здесь дела лучше, чем в предудыщем случае. Здесь разрешено использовать условия, но цветом выделить нужное возможности нет.
...
Самый приспособленный пакет для построения коробчатых диаграмм. Все, что требовалось, то и вышло.
